...
//				} else {
					...
					bundle.putString("edttext", "Thank You");
				    bundle.putString("input", inputString+"");
				bundle.putString("discount", discountstring+"");


			//	Toast.makeText(getActivity().getBaseContext(), "discount:"+discountstring, Toast.LENGTH_SHORT).show();
