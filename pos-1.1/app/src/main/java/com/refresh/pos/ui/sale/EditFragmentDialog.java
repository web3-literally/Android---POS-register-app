    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        comfirmButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double price = lineItem.getProduct().getUnitPrice() ;
                if (!quantityBox.getText().toString().equalsIgnoreCase("")){
                    qty = Integer.parseInt(quantityBox.getText().toString());
                }
                if(!priceBox.getText().toString().equalsIgnoreCase("")){
                    price = Double.parseDouble(priceBox.getText().toString()) ;
                }
                register.updateItem(
